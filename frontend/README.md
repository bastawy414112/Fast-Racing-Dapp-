...
<h1><strong> Fast Racing | Frontend </strong></h1>
<br/>
<img src="./public/img/Fast_Racing_logo_HD.png" width="200" alt="Fast Racing logo" />
<br>
...
- [Installation](#installation)
  ...
  - [To start Fast Racing:](#to-start-Fast-racing)
- [Credits](#credits)
...
The front end of Fast Racing has been built to make the interaction with the smart contracts as smooth as possible. Only one transaction is required to play a game, even as a new player. All racing modes are accessible directly from the front end.
