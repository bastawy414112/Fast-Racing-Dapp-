...
contract DeployerTest is Script {
    ...
    uint256 immutable VRF_SUBSCRIPTION_ID = 98898291528854366924693649837002479487253521925319728018884692801894060486048; // AVAX FUJI
    uint64 immutable FUNCTIONS_SUBSCRIPTION_ID = 5298; // AVAX FUJI
